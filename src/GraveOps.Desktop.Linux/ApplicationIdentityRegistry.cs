...
internal sealed record ApplicationProductDefinition(
    string Product,
    string Category,
    string[] ServiceUnits,
...
{
    internal static IReadOnlyList<ApplicationProductDefinition>
        Definitions { get; } =
        new[]
        {
    ...
    internal static ApplicationProductDefinition? Find(
        string? product) =>
