...
public sealed class LinuxDownloadQueueRow
{
...
public sealed class LinuxDownloadHistoryRow
{
    public string Name { get; set; } = string.Empty;
    public string Category { get; set; } = string.Empty;
    public string State { get; set; } = string.Empty;
...
public sealed class LinuxDownloadClientSnapshot
{
    ...
    public List<LinuxDownloadQueueRow> Queue { get; set; } =
        new();

    public List<LinuxDownloadHistoryRow> History { get; set; } =
        new();
}
...
internal sealed class LinuxDownloadClientTelemetryService
{
    ...
    public async Task<LinuxDownloadClientSnapshot>
        CaptureAsync(
